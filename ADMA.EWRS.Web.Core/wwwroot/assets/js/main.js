...
var Main = function () {
    ...
    var sidebarHandler = function () {
        var eventObject = isTouch() ? 'click' : 'mouseenter',
            ...
            $winOffsetTop = 0, $winScrollTop = 0, $appWidth, space = 0;
    ...
    $('.sidebar-toggler').on('click', function () {
        ...
        //debugger; //Murad :: Info : Disabled cause i removed setting element from master page 
    ...
    var settingsHandler = function () {
        ...
        //**********************************************************************
        //Murad :: Info : No Need since theme already selected 
        //**********************************************************************
        /*
