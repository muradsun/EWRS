...
{
    public class ReviewWorkflowWizardStepViewComponent : ViewComponent
    {
        ...
        public ReviewWorkflowWizardStepViewComponent(IServiceProvider provider, IClaimsSecurityManager claimsSecurityManager)
        {
            _provider = provider;
        ...
        public async Task<IViewComponentResult> InvokeAsync(int projectId)
        {
            ...
            return View("~/Views/Project/Components/ReviewWorkflowWizardStep.cshtml");
        }
